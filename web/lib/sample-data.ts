...
export const SAMPLE_PACKETS: Packet[] = [
  {
    id: 1, timestamp: ago(0), srcIp: "10.8.0.2", dstIp: "1.1.1.1",
  ...
  {
    id: 2, timestamp: ago(2), srcIp: "10.8.0.2", dstIp: "93.184.216.34",
  ...
  {
    id: 3, timestamp: ago(5), srcIp: "10.8.0.2", dstIp: "8.8.8.8",
    srcPort: 60001, dstPort: 53, protocol: "DNS", bytes: 64,
    direction: "outbound", hostName: null, tlsSni: null,
    dnsQuery: "github.com", rawJson: null, createdAt: ago(5),
  },
  {
    id: 4, timestamp: ago(6), srcIp: "10.8.0.2", dstIp: "140.82.121.4",
  ...
  {
    id: 5, timestamp: ago(10), srcIp: "140.82.121.4", dstIp: "10.8.0.2",
  ...
  {
    id: 6, timestamp: ago(15), srcIp: "10.8.0.2", dstIp: "142.250.196.110",
  ...
  {
    id: 7, timestamp: ago(20), srcIp: "10.8.0.2", dstIp: "13.35.16.45",
  ...
  {
    id: 8, timestamp: ago(30), srcIp: "10.8.0.2", dstIp: "1.1.1.1",
    srcPort: 54900, dstPort: 53, protocol: "DNS", bytes: 80,
    direction: "outbound", hostName: null, tlsSni: null,
    dnsQuery: "api.example.com", rawJson: null, createdAt: ago(30),
  },
  {
    id: 9, timestamp: ago(35), srcIp: "10.8.0.2", dstIp: "104.26.10.50",
  ...
  {
    id: 13, timestamp: ago(180), srcIp: "10.8.0.2", dstIp: "52.84.0.10",
  ...
  {
    id: 14, timestamp: ago(240), srcIp: "10.8.0.100", dstIp: "10.8.0.2",
    srcPort: 51820, dstPort: 51820, protocol: "UDP", bytes: 148,
    direction: "inbound", hostName: null, tlsSni: null,
    dnsQuery: null, rawJson: null, createdAt: ago(240),
  },
  {
    id: 15, timestamp: ago(300), srcIp: "10.8.0.2", dstIp: "172.217.25.14",
